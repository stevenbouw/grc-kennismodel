...
Ontologie-evolutie van v0.x tot v4.6.0. **v4.6.0 is laatste geplande Spoor A-sprint vóór migratie naar Claude Code + GitHub.**
...
| **v4.6.0** | **2026-05-21** | **active** | **Fase 4: M15-ENSIA-uitbouw + Volwassenheidsmodel (isms-cluster naast biz) + CSF Tiers + 5 modules gewijzigd** |
...
## v4.6.0 baseline-metrics (huidige active)
...
|---|---|---|
| (geen v4.7.0 nu) | — | Vervolgfase: MIGRATIE naar Claude Code + GitHub voor Tech/Brein/Dashboard chats |
| v4.7.0 (post-migratie) | TBD | Eerste post-migratie-sprint, scope tbd. Kandidaten: SKOS-kwaliteitsanalyse / ENISA TIG / Spoor B-voorbereiding |
