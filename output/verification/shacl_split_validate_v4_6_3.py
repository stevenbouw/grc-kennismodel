#!/usr/bin/env python3
"""shacl_split_validate_v4_6_3.py — gesplitste SHACL-validatie v4.6.3.

Output-bestand: output/verification/shacl_results_v4_6_3.json.
...
T3-patch v4.6.3 muteert 2 SKOS-predicates in m14-avg-gdpr.ttl (2 broadMatch
...
OUTPUT_PATH = REPO_ROOT / "output" / "verification" / "shacl_results_v4_6_3.json"
